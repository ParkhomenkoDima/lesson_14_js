...
function evenFn(n) {
  ...
  for (var i = 1; i <= n; i++) for (var j = i; j % 2 === 0; j++) arr.push(i);

  return arr;
}

console.log('---------------------');
console.log('0: ', evenFn(0));
console.log('10: ', evenFn(10));
console.log('15: ', evenFn(15));
console.log('20: ', evenFn(20));
/*
 * #5
 *
...
console.log('---------------------');
console.log('1: ', weekFn(1));
console.log('3: ', weekFn(3));
console.log('7: ', weekFn(7));
console.log('9: ', weekFn(9));
console.log('1.5: ', weekFn(1.5));
console.log('"2": ', weekFn('2'));
...
console.log('---------------------');
console.log('oddFn(0) = ', oddFn(0));
console.log('oddFn(10) = ', oddFn(10));
console.log('oddFn(10) = ', oddFn(15));
console.log('oddFn(10) = ', oddFn(20));
...
console.log('---------------------');
console.log('mainFunc(a, b, func)', mainFunc(1, 2, func));
console.log('mainFunc(a, b)', mainFunc(1, 2));
...
console.log('---------------------');
console.log(
  'произвольное целое число в диапазоне между 2 и 5: ',
  mainFunc(2, 5, cbRandom)
);
console.log('число 2 в степени 5', mainFunc(2, 5, cbPow));
console.log('сумма чисел 2 и 5.', mainFunc(2, 5, cbAdd));
console.log('mainFunc(2, 5, "not a func":) ', mainFunc(2, 5, 'not a func'));
